...
function setup() {
  ...
  var brokenBoatFrames = brokenBoatSpritedata.frames;// el nombre de la variable estaba incompleta brokenBoatFrames
  ...
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      if (boats[i]) {
        ...
        boats[i].display();
        boats[i].animate();// la funcion que hicimos en la clase boat se llama "animate"
